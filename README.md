...
- **Automatisierte Testsuite**:
   - 90 automatisierte Tests mit **Jest** für Spiellogik, Regeln, Matchmaking, Socket-Integration und Sicherheit/DoS-Schutz.
...
Getestet werden (90 Tests in 6 Test-Dateien):
